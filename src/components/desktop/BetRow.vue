<template>
  <div>
    <div class="flex items-center px-5 py-[5px] bg-lighter-warning dark:bg-header-bg dark:text-white">
      <div class="flex grow items-center justify-between mr-3 font-bold text-header-bg text-xs">
      ...
      <div class="flex">
        <PointCard
          ...
          class="last:mr-0"
          :class="{
            'mr-[14px]': key + 1 == points.length / 2,
            'mr-[7px]': key + 1 !== points.length / 2
          }"
          @click="handleClick"
        />
      </div>
